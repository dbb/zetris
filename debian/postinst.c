...
static const char filename[] = "/var/games/zetris.scores";
...
{
   /* dh_installdocs */
   system ("if [ -d /usr/doc -a ! -e /usr/doc/zetris -a -d /usr/share/doc/zetris ]; then\n"
		   "	ln -sf ../share/doc/zetris /usr/doc/zetris\n"
		   "fi\n");
